...
# -*- coding: utf-8 -*-
#
# ArduRPC documentation build configuration file.

# NOTE: This file has been edited manually from the auto-generated one from
# sphinx. Do NOT delete and/or re-generate.
#
...
for line in fp:
    ...
    name = m.group('name')
    value = m.group('value')
    if name == 'RPC_VERSION_MAJOR':
        version_parts[0] = value

    if name == 'RPC_VERSION_MINOR':
        version_parts[1] = value

    if name == 'RPC_VERSION_PATCH':
